...
${OBJECTDIR}/PriorityQueue.o: PriorityQueue.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PriorityQueue.o PriorityQueue.c
...
${OBJECTDIR}/fifo_queue.o: fifo_queue.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/fifo_queue.o fifo_queue.c

${OBJECTDIR}/fifo_queue_test.o: fifo_queue_test.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/fifo_queue_test.o fifo_queue_test.c
